...
from goodstore import views
from django.conf import settings
from django.conf.urls.static import static
from goodstore.views import profile, add_to_cart, view_cart, checkout, order_history, personal_cabinet_redirect
from django.contrib.auth import views as auth_views


urlpatterns = [
    path('', views.add_good, name='home'),
